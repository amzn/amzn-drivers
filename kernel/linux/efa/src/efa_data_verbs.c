...
static void efa_wqe_set_send_inline_data(const struct ib_send_wr *wr,
...
static void efa_wqe_set_rdma_info(const struct ib_send_wr *wr, struct efa_io_tx_meta_desc *md,
