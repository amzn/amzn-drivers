...
#if defined(ENA_DEVLINK_SUPPORT) && \
...
#if defined(ENA_DEVLINK_SUPPORT) && LINUX_VERSION_CODE >= KERNEL_VERSION(5, 10, 0)
...
#if defined(ENA_DEVLINK_SUPPORT) && \
	((KERNEL_VERSION(5, 16, 0) <= LINUX_VERSION_CODE && LINUX_VERSION_CODE < KERNEL_VERSION(6, 3, 0)) || \
	(defined(SUSE_VERSION) && (SUSE_VERSION == 15 && SUSE_PATCHLEVEL >= 4))  || \
